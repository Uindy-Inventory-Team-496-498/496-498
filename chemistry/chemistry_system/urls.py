...
urlpatterns = [
    ...
    path('export_chemicals_csv/', export_chemicals_csv, name='export_chemicals_csv'),  # Update the URL pattern
    path('import_chemicals_csv/', import_chemicals_csv, name='import_chemicals_csv'),  # Update the URL pattern
    ...
    path('download-qr-pdf/', views.generate_qr_pdf_view, name='download_qr_pdf'),  # Update the URL pattern
